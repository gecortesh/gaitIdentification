...
class Manager(object):
    ...
    def point_angles(self):
        return self.get('POINT:ANGLES').string_array
        
    @property
    def event_used(self):
        return self.get_uint16('EVENT:USED')
    ...
    def event_labels(self):
        return self.get('EVENT:LABELS').string_array
        
    @property
    def event_contexts(self):
        return self.get('EVENT:CONTEXTS').string_array
        
    @property
    def event_times(self):
        return self.get_uint16('EVENT:TIMES')
